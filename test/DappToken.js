...
contract("DappToken",function(accounts)
{
    ...
    it('initializes the contract with the correct values' ,function(){
        ...
        {
            assert.equal(symbol ,'DAPP','has the coreect symbol');
    ...
    it('allocate initial  supply upon deployment' ,function()
    {
        ...
        it('transfer token ownership' ,function(){
            ...
            }).then(function(balacne){assert.equal(balacne.toNumber(),250000,"adds the amount to the receiving account")
                return tokenInstance.balanceOf(accounts[0]);
        ...
        it('handels delegated token transfer ' ,function()
        {
            return DappToken.deployed().then(function(instance){
                tokenInstance =instance;
                ...
                //Try transferring something lager than the sender's balance 
                ...
                assert.equal(receipt.logs[0].args._to ,toAccount,'logs the account the token are authorized to')
